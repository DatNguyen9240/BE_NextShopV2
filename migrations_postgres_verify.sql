...
CREATE TABLE "ProductVariants" (
    ...
    "PriceAfterDiscount" decimal(18,0) NOT NULL,
    "StockQuantity" int NOT NULL,
    "IsDefault" bit NOT NULL,
    "DisplayOrder" int NOT NULL,
    "ImageUrl" nvarchar(max),
    "ImgHover" nvarchar(max),
...
CREATE TABLE "Orders" (
    ...
    "AdminCancelReason" nvarchar(max),
...
CREATE TABLE "OrderItems" (
    ...
    "VariantOptionsJson" nvarchar(max),
...
CREATE TABLE "Payments" (
    ...
    "Status" nvarchar(max) NOT NULL,
    "ProviderPaymentId" nvarchar(max),
    "ProviderData" nvarchar(max),
    "CreatedAt" datetime2 NOT NULL,
...
CREATE TABLE "TrackingEvents" (
    "TrackingEventId" uniqueidentifier NOT NULL,
    "ShipmentId" uniqueidentifier NOT NULL,
    "Status" nvarchar(max) NOT NULL,
...
VALUES ('20260128061821_InitCreate', '9.0.9');
